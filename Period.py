...
class Period:
	...
	def lightcurve_clip(self, mag = None, magerr = None, time = None,error_clip = False, s_fit = False, time_res = 0):


		if mag.all() == None and magerr.all() == None and time.all() == None:
			mag, magerr, time = self.synthesize()

		mag, magerr, time = lightcurve_clip(mag,magerr,time,error_clip,s_fit,time_res)
